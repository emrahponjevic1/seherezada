    ...
    <>
      <div className="md:hidden fixed bottom-24 right-4 z-50 flex flex-col items-end gap-2">
        <button
          ...
          className="group relative h-16 px-6 bg-white text-black rounded-full flex items-center justify-center gap-3 shadow-[0_0_40px_-10px_rgba(255,255,255,0.8)] active:scale-95 transition-all duration-300 animate-float-slow"
        >
          <span className="absolute inset-0 rounded-full bg-gradient-to-tr from-white to-gray-200 z-0"></span>
          <span className="absolute -inset-1.5 rounded-full bg-white opacity-40 blur-md animate-pulse"></span>
          <UtensilsCrossed size={22} className="relative z-10 text-shere-red" />
          <span className="relative z-10 font-black tracking-wide text-lg">{t("Meni", "Menu")}</span>
        </button>
      </div>
